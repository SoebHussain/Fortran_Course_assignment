...
cp(1,1)=0.80000000000000004
cp(1,2)=-0.59999999999999998   ! value of cp initial
cp(2,1)=0.59999999999999998 
cp(2,2)= 0.80000000000000004
!write(6,*) cp

call citerate(cp,sout,c)  ! calculation of c from c prime
do i=1,19
call funct(a,hcore,c,f) ! calculation of f
call fprime(sout,f,fp) !calculation of fp
call cprime(fp,cp) ! calculation of c prime
call citerate(cp,sout,c) !calculation of c
